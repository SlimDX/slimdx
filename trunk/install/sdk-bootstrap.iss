[Setup]
OutputBaseFileName=SlimDX SDK (June 2010)
AppName=SlimDX SDK Prerequisites (June 2010)
AppVerName=SlimDX SDK Prerequisites (June 2010)
AppPublisher=SlimDX Group
AppPublisherURL=http://slimdx.org
AppVersion=10.43
AppCopyright=Copyright (C) 2007-2010 SlimDX Group
VersionInfoProductName=SlimDX SDK (June 2010)
VersionInfoDescription=SlimDX SDK (June 2010)
VersionInfoVersion=10.43
Compression=lzma2
