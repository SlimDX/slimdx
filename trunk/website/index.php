...
<div id="content">
	<div class="wrapper">    
        ...
        <div id="right_column">
			...
			Several commercial projects and companies are using SlimDX, including one shipped AAA game title for Windows.
