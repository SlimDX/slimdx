	...
	<div class="wrapper">
        ...
        the library. This should be the most feature-full and stable release of SlimDX yet.
			...
			<div class="paragraph">
				...
				<ul>
				<li><a href="http://slimdx.org/latestdocs/Default.aspx?topic=SlimDX+Software+Development+Kit%2fWhat%27s+Changed+in+the+February+2010+SDK" rel="nofollow">What&#x27;s Changed in the February 2010 SDK</a> -- Information on the work we did for the February 2010 SDK release.</li>
		...
		<div id="right">
			<ul class="sidemenu">
				<li><a href="http://slimdx.org/latestdocs/Default.aspx?topic=SlimDX+Software+Development+Kit%2fWhat%27s+Changed+in+the+February+2010+SDK">Release Notes</a></li>
