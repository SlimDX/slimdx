<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DocSiteHeader.ascx.cs" Inherits="DocSiteTest.Controls.DocSiteHeader" %>
...
<asp:Image runat="server" id="logoImage" CssClass="docsite_logo" ImageUrl="~/Images/SdxLogo.png" meta:resourcekey="logoImageResource1" />
<div id="docsite_header_title"><%= DocSiteTest.DocSite.ProjectTitle %></div>
<div id="docsite_header_company"><%= DocSiteTest.DocSite.ProjectCompany %></div>