<?php
	$g_pageTitle = "SlimDX Download Page (March 2011)";
	$g_pageName = "Download";
...
<div id="content">
	<div class="wrapper">
        ...
        <br />
				<p>
          The March 2011 release of SlimDX was a bug fixing and stability release. In this release we diverged from the usual practice
          of synchronizing our schedule with that of the DirectX SDK, mostly due to the long wait since the previous release, June 2010.
          March 2011 boasts several bug fixes, some performance improvements, a few bits of missing functionality, and a couple new samples,
          and we decided that we couldn't wait any longer for the release.
        </p><br />
			</div>
        ...
        <p>
          ...
          It works on both 32 and 64 bit systems, for all versions of Windows supported by the .NET Framework. Pick the one that matches your target framework.
        </p>
        <br />
        <p>
        If you're just trying to run a SlimDX program that someone else gave you, you will need one of these installers.
				Developers should point users to one of these links, or include it with their own installers.
				However, developers should install the SDK below, not this package.
				See the documentation for more information.
				</p><br />
				<a href="http://slimdx.googlecode.com/files/SlimDX%20Runtime%20for%20.NET%202.0%20%28March%202011%29.msi"><img src="images/install_20.png" alt=".NET 2.0 User Runtime" /></a>
        <a href="http://slimdx.googlecode.com/files/SlimDX%20Runtime%20for%20.NET%204.0%20%28March%202011%29.exe"><img src="images/install_40.png" alt=".NET 4.0 User Runtime" /></a>
			</div>
			...
			<div class="paragraph">
				...
				<a href="http://slimdx.googlecode.com/files/SlimDX%20SDK%20%28March%202011%29.exe"><img src="images/install_sdk.png" alt="Latest Developer SDK" /></a>
			</div>
			...
			<div class="paragraph">
				...
				<ul>
				<li><a href="http://slimdx.org/latestdocs/Default.aspx?topic=SlimDX+Software+Development+Kit%2fWhat%27s+Changed+in+the+March+2011+SDK" rel="nofollow">What&#x27;s Changed in the March 2011 SDK</a> -- Information on the work we did for the March 2011 SDK release.</li>
		...
		<div id="right">
			<ul class="sidemenu">
				<li><a href="http://slimdx.org/latestdocs/Default.aspx?topic=SlimDX+Software+Development+Kit%2fWhat%27s+Changed+in+the+March+2011+SDK">Release Notes</a></li>
