...
{
    /// <summary>
    /// Represents a vertex that has a position and texture mapping information.
    /// </summary>
    [Serializable]
    public struct VertexPositionTexture : IEquatable<VertexPositionTexture>
    {
        ...
        {
            return string.Format(CultureInfo.CurrentCulture, "Position={0}, TexCoords={1}", Position, TextureCoordinates);
        }
